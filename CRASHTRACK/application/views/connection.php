            ...
            <div class="container-fluid" id="conn">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Connection</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Connection</li>
                        </ol>
                    </div>
                    <div class="col-md-7 align-self-center text-right d-none d-md-block" id="sts">
                        <button type="button" class="btn btn-secondary" disabled><i class="fa fa-circle-o-notch"></i> RECONNECTING</button>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-body printableArea">
                            <h3><b>TOPIC</b> <span class="pull-right">MESSAGE</span></h3>
                            <hr>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <address>
                                            <h3 id="messages"> &nbsp;<b class="text-danger">MQTT Topic</b></h3>
                                            <p class="text-muted m-l-5">Upcoming topics
                                    ...
                                    <div class="pull-right text-right">
                                        <address>
                                            <h3>Coor,</h3>
                                            <h4 id="gps_coor" class="font-bold">MQTT Message,</h4>
                                            <p class="text-muted m-l-30">Upcoming messages
                                                <br/> will be displayed
                                                <br/> in this section,
                                                <br/> Black - Section</p>
                                            <p class="m-t-30" id="mdate"><b>Message Date :</b> <i class="fa fa-calendar"></i> 0000-00-00</p>
                                            <p id="mtime"><b>Message Time :</b> <i class="fa fa-clock-o"></i> 00:00:00</p>
                                        </address>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right m-t-30 text-right">
                                        <p>This table is temporary</p>
                                        <p>Will disappear when the page is refreshed or reloaded</p>
                                        <!--<h3><b>Total :</b> $13,986</h3>-->
                                    </div>
                                    <div class="clearfix"></div>
                                    <hr>
                                    <div class="text-right">
                                        <button class="btn btn-outline-danger">MQTT</button>
                                        <button class="btn btn-outline-secondary">CONNECTION</button>
                                    </div>
                                </div>
                            </div>
                        </div>
