            ...
            <div class="container-fluid" id="maps">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Maps Tracker</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Maps Track</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Track GPS</h4>
                                <h6 class="card-subtitle">Just <code>click</code> the button to track device position.</h6>
                                <div class="row button-group" id="divTrack">
